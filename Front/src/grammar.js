...
function peg$parse(input, options) {
  ...
  function peg$parseparserexpression() {
    var s0;
  ...
  function peg$parseparexpression() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = peg$parse_();
      s3 = peg$parseparserexpression();
      if (s3 !== peg$FAILED) {
        s4 = peg$parse_();
        s5 = [];
        s6 = peg$currPos;
        s7 = peg$parseparserexpression();
        if (s7 !== peg$FAILED) {
          s8 = peg$parse_();
          s7 = [s7, s8];
          s6 = s7;
