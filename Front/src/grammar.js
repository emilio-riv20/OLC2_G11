...
function peg$parse(input, options) {
  ...
  var peg$e5 = peg$classExpectation(["_", ["a", "z"]], false, false);
  var peg$e6 = peg$classExpectation(["_", ["a", "z"], ["0", "9"]], false, false);
  ...
  var peg$f1 = function(name, expression) { 
        return { name: name, expression: expression }; 
    };
  var peg$f2 = function(name, expression) { 
        return { name: name, expression: expression }; 
    };
  var peg$f3 = function(base, locks) {
        if(locks == "?"){
  ...
  var peg$f13 = function(concate) { return concate.join(""); };
  ...
  function peg$parseexpressionlocks() {
    var s0, s1, s2, s3;
  ...
  function peg$parseliteral_chars() {
    var s0, s1;
...
// Exporta solo la función parse por defecto
